...
bool addApple(gameData gameInfo) {
	...
	int newRow = validSpaces[appleCoorIndx].Row;
	int newCol = validSpaces[appleCoorIndx].Column;
	board[newRow][newCol].hasApple = true;

	gameInfo.appleLocation->Row = newRow;
	gameInfo.appleLocation->Column = newCol;
